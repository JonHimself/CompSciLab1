...
// ANSWER: O(n) but it would be O(1) if numbers never changes
...
// ANSWER: Constant is the best time complexity
...
function squareEveryDigit(number) {
  let squared = number.toString().split("");
  for (let i = 0; i < squared.length; i++) {
    square += (squared[i] * squared[i]).toString();
  }
  console.log(square);
}
...
// When running 946, you should see a result of 811636
